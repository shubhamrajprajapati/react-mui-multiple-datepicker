...
var DateDisplayWithoutTheme = /*#__PURE__*/function (_Component) {
  _inherits(DateDisplayWithoutTheme, _Component);
  var _super = _createSuper(DateDisplayWithoutTheme);
  function DateDisplayWithoutTheme() {
    var _this;
    _classCallCheck(this, DateDisplayWithoutTheme);
  ...
  _createClass(DateDisplayWithoutTheme, [{
  ...
  return DateDisplayWithoutTheme;
}(_react.Component);
var DateDisplay = function DateDisplay(props) {
  return /*#__PURE__*/_react["default"].createElement(DateDisplayWithoutTheme, _extends({}, props, {
    theme: (0, _material.useTheme)()
  }));
};
